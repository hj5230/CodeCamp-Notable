  ...
  render() {
    return (
      <Navbar bg="light" expand="lg">
        <Container>
          <Navbar.Brand onClick={this.handleIndexPage}>
          ...
          <Navbar.Collapse id="basic-navbar-nav">
            <Nav className="me-auto">
              <ButtonGroup>
                ...
                <Button variant='outline-primary' onClick={this.handleTranslate}>
                ...
                <Button variant='outline-primary' target='_blank' href='https://github.com/hj5230/CodeCamp-Notable'>
